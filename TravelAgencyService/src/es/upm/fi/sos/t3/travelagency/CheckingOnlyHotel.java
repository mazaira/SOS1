 ...
 */
            ...
            /**
            *  CheckingOnlyHotel bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CheckingOnlyHotel
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"checkingOnlyHotel".equals(type)){
                                ...
                                return (CheckingOnlyHotel)es.upm.fi.sos.t3.travelagency.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
