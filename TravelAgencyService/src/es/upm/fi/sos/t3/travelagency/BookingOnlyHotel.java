 ...
 */
            ...
            /**
            *  BookingOnlyHotel bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BookingOnlyHotel
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"bookingOnlyHotel".equals(type)){
                                ...
                                return (BookingOnlyHotel)es.upm.fi.sos.t3.travelagency.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
