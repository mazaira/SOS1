...
/**
 * CheckingOnlyHotelResponse.java
 *
 ...
 */
            ...
            /**
            *  CheckingOnlyHotelResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CheckingOnlyHotelResponse
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"checkingOnlyHotelResponse".equals(type)){
                                ...
                                return (CheckingOnlyHotelResponse)es.upm.fi.sos.t3.travelagency.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
