 ...
 */
            ...
            /**
            *  CheckingOnlyFlight bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CheckingOnlyFlight
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"checkingOnlyFlight".equals(type)){
                                ...
                                return (CheckingOnlyFlight)es.upm.fi.sos.t3.travelagency.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
