 ...
 */
            ...
            /**
            *  BookingOnlyHotelResponse bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class BookingOnlyHotelResponse
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"bookingOnlyHotelResponse".equals(type)){
                                ...
                                return (BookingOnlyHotelResponse)es.upm.fi.sos.t3.travelagency.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
