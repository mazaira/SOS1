 ...
 */
            ...
            /**
            *  CancellingOnlyHotel bean class
            */
            @SuppressWarnings({"unchecked","unused"})
        
        public  class CancellingOnlyHotel
                  ...
                  if (fullTypeName!=null){
                    ...
                    java.lang.String type = fullTypeName.substring(fullTypeName.indexOf(":")+1);
                            ...
                            if (!"cancellingOnlyHotel".equals(type)){
                                ...
                                return (CancellingOnlyHotel)es.upm.fi.sos.t3.travelagency.ExtensionMapper.getTypeObject(
                                     nsUri,type,reader);
                              }
